...
#define TWOWAY_RULE(name1, name2, latexName, premisse, conclusion)            \
    rules.push_back(new Rule(name1, latexName, premisse, conclusion));\
    rules.push_back(new Rule(name2, latexName, conclusion, premisse));
...
vector<Rule*> createRules()
{
    ...
    /* / R */
    rules.push_back(new Rule("⇐ᴿ", "\\slash R",
    ...
    /* \ R */
    rules.push_back(new Rule("⇒ᴿ", "\\backslash R",
    ...
    /* (/) L */
    rules.push_back(new Rule("⇚ᴸ", "\\oslash L",
    ...
    /* (\) L */
    rules.push_back(new Rule("⇛ᴸ", "\\obslash L",
    ...
    /* \ L */
    rules.push_back(new Rule("⇒ᴸ", "\\backslash L",
    ...
    /* / L */
    rules.push_back(new Rule("⇐ᴸ", "\\slash L",
    ...
    /* (/) R */
    rules.push_back(new Rule("⇚ᴿ", "\\oslash R",
    ...
    /* (\) R */
    rules.push_back(new Rule("⇛ᴿ", "\\obslash R",
