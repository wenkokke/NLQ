...
\begin{frame}
  ...
  \only<1-2>{%
    \begin{pfbox}[0.9]
      \AXC{}\RightLabel{Ax}\UIC{$\struct{{\color{red}\NP}}\fCenter\struct{\NP}$}
      \AXC{}\RightLabel{Ax}\UIC{$\struct{\S}\fCenter\struct{{\color{red}\S}}$}
      \RightLabel{L$\impr$}
      \BIC{$\struct{\NP\impr\S}\fCenter\struct{{\color{red}\NP}}\impr\struct{{\color{red}\S}}$}
      \RightLabel{Res$\impr\prod$}
      \only<1>{%
        \UIC{$\struct{{\color{red}\NP}}\prod\struct{\NP\impr\S}\fCenter\struct{{\color{red}\S}}$}
      }
      \only<2>{%
        \UIC{$\boxed{\struct{{\color{red}\NP}}\prod\struct{\NP\impr\S}\fCenter\struct{{\color{red}\S}}}$}
      }
      \RightLabel{Res$\prod\impr$}
      \UIC{$\struct{\NP\impr\S}\fCenter\struct{{\color{red}\NP}}\impr\struct{{\color{red}\S}}$}
      \RightLabel{R$\impr$}
      \UIC{$\struct{\NP\impr\S}\fCenter\struct{{\color{red}\NP\impr\S}}$}
      \AXC{}\RightLabel{Ax}\UIC{$\struct{\S}\fCenter\struct{\S}$}
      \BIC{$\struct{{\color{red}\S\impl(\NP\impr\S)}}\fCenter\struct{\S}\impl\struct{\NP\impr\S}$}
      \RightLabel{Res$\impl\prod$}
      \UIC{$\struct{{\color{red}\S\impl(\NP\impr\S)}}\prod\struct{\NP\impr\S}\fCenter\struct{\S}$}
    \end{pfbox}
  }
  \only<3>{%
    \begin{pfbox}[0.9]
      ...
      \UIC{$
        ...
        \struct{{\color{red}\NP}}
        \fCenter\struct{{\color{red}\S}}$}
      \RightLabel{$\downarrow$}
      \UIC{$
        \struct{{\color{red}\NP}}\prod
        \struct{\NP}\prod
        \struct{(\NP\impr\S)\impl\NP}\prod\I
        \fCenter\struct{{\color{red}\S}}$}
      \RightLabel{Res$\prod\impr$}
      \UIC{$
        \struct{\NP}\prod\struct{(\NP\impr\S)\impl\NP}\prod\I
        \fCenter
        \struct{{\color{red}\NP}}\impr\struct{{\color{red}\S}}$}
      \RightLabel{R$\impr$}
      \UIC{$
        \struct{\NP}\prod\struct{(\NP\impr\S)\impl\NP}\prod\I
        \fCenter
  ...
  \only<5>{%
    \begin{pfbox}[0.9]
      ...
      \UIC{$
        \struct{{\color{green}\NP}}\prod
        \struct{(\NP\impr\S)\impl\NP}\prod\I
        \fCenter\struct{{\color{red}\NP}}\impr\struct{\S}$}
      \RightLabel{$\downarrow$}
      \UIC{$
        \struct{{\color{green}\NP}}\prod
        \I\prod
  ...
  \only<2->{%
    ...
    \onslide<3->{%
      ...
      \item[--] boxes might be useful, since they can cancel out
        diamonds\\i.e. using $\qr[\S\impl(\sq\NP\impr\S)]$;
