...
MARY_THINKS'_SOMEONE_LEFT₀ : LG ⟨ · np · ⊗ (· (np ⇒ s⁻) ⇐ ◇ s⁻ · ⊗ ⟨ · (np ⇐ n) ⊗ n · ⊗ · np ⇒ s⁻ · ⟩) ⟩ ⊢[ ◇ s⁻ ]
MARY_THINKS'_SOMEONE_LEFT₀ = ◇ᴿ (⇁ (r⇒⊗ (r⇐⊗ (↼ (⇐ᴸ (◇ᴿ (⇁ (r⇐⊗ (⊗ᴸ (r⇐⊗ (↼ (⇐ᴸ ax⁺ (↽ (r⊗⇐ (r⇒⊗ (↼ (⇒ᴸ ax⁺ ax⁻)))))))))))) (⇒ᴸ ax⁺ ax⁻))))))
mary_thinks'_someone_left₀ : ⟦ ◇ s⁻ ⟧ᵀ
mary_thinks'_someone_left₀ = [ MARY_THINKS'_SOMEONE_LEFT₀ ]ᵀ (mary , thinks' , someone , left , ∅)
--> THINKS mary (exists (λ x → PERSON x ∧ LEFT x))
