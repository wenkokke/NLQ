...
module Logic.Classical.Linear.LambekGrishin.Trans {ℓ} (Univ : Set ℓ) where


open import Logic.Polarity
open import Logic.Classical.Linear.LambekGrishin.Type                        Univ as T
open import Logic.Classical.Linear.LambekGrishin.Type.Context.Polarised      Univ as TCP using ([])
...
open import Logic.Classical.Linear.LambekGrishin.Origin                      Univ as LGO
