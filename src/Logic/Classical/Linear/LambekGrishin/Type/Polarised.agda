...
module Logic.Classical.Linear.LambekGrishin.Type.Polarised {ℓ} (Univ : Polarity → Set ℓ) where


open import Logic.Classical.Linear.LambekGrishin.Type (Σ Polarity Univ)
