...
module Logic.Classical.Linear.LambekGrishin.Judgement.Context {ℓ} (Univ : Set ℓ) where


open import Logic.Classical.Linear.LambekGrishin.Type         Univ as T
open import Logic.Classical.Linear.LambekGrishin.Type.Context Univ as TC hiding (module Simple; module Context; Context)
