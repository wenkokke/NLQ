...
module Logic.Classical.Linear.LambekGrishin.Judgement.Context.Polarised {ℓ} (Univ : Set ℓ) where


open import Logic.Polarity
open import Logic.Classical.Linear.LambekGrishin.Type                   Univ as T
open import Logic.Classical.Linear.LambekGrishin.Type.Context           Univ as TC  hiding (module Simple)
open import Logic.Classical.Linear.LambekGrishin.Type.Context.Polarised Univ as TCP hiding (module Simple; module Polarised; Polarised)
open import Logic.Classical.Linear.LambekGrishin.Judgement              Univ
open import Logic.Classical.Linear.LambekGrishin.Judgement.Context      Univ as JC  hiding (module Simple)
