...
open import Logic.Classical.Ordered.LambekGrishin.Type             Atom as Type
open import Logic.Classical.Ordered.LambekGrishin.ResMon.Judgement Atom as Judgement
open import Logic.Classical.Ordered.LambekGrishin.ResMon.Base      Atom

open Type.DecEq      _≟-Atom_ using (_≟-Type_)
open Judgement.DecEq _≟-Atom_ using (_≟-Judgement_)
