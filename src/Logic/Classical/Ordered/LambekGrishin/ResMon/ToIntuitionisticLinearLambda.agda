...
mutual
  ...
  ⌈ r⊗⇐ f   ⌉ᴸ = {!!}
  ⌈ m⊕  f g ⌉ᴸ = {!!}
  ⌈ m⇚  f g ⌉ᴸ = ⇒ᵢ (⊗ₑᴸ₁ (    (⇒ₑ ⌈ f ⌉ᴿ (⇒ᵢ (eᴸ₂ (⇒ₑ ax (    (⊗ᵢ ax ⌈ g ⌉ᴸ))))))))
  ⌈ m⇛  f g ⌉ᴸ = ⇒ᵢ (⊗ₑᴸ₁ (eᴸ₁ (⇒ₑ ⌈ g ⌉ᴿ (⇒ᵢ (eᴸ₂ (⇒ₑ ax (eᴸ₁ (⊗ᵢ ⌈ f ⌉ᴸ ax))))))))
  ⌈ r⇛⊕ f   ⌉ᴸ = ⇒ᵢ (eᴸ₁ (⇒ₑ ax (⇒ᵢ (⊗ₑᴸ₁ (eᴸ₂ (⊗ᵢᴸ₁ (eᴸ₁ {!⌈ f ⌉ᴸ!})))))))
  ⌈ r⊕⇛ f   ⌉ᴸ = {!!}
  ⌈ r⊕⇚ f   ⌉ᴸ = {!!}
  ⌈ r⇚⊕ f   ⌉ᴸ = {!!}
  ⌈ d⇛⇐ f   ⌉ᴸ = {!!}
  ...
  ⌈ r⇒⊗ f   ⌉ᴿ = ⊗ₑᴸ₁ (⇒ᵢ (    (eᴸ₁ (⊗ᵢᴸ₁ (eᴸ₁ (⇒ₑ (⇒ₑ (⇒ᵢ ¬¬ᵢ) ⌈ f ⌉ᴿ) ax))))))
  ⌈ r⇐⊗ f   ⌉ᴿ = ⊗ₑᴸ₁ (⇒ᵢ (eᴸ₂ (eᴸ₁ (⊗ᵢᴸ₁ (eᴸ₁ (⇒ₑ (⇒ₑ (⇒ᵢ ¬¬ᵢ) ⌈ f ⌉ᴿ) ax))))))
  ⌈ r⊗⇒ f   ⌉ᴿ = ⇒ᵢ (⇒ₑ ax (⇒ᵢ (⊗ₑᴸ₁ (eᴸ₂ (eᴸ₁ (⊗ᵢᴸ₁ (⇒ₑ ⌈ f ⌉ᴿ ax)))))))
  ⌈ r⊗⇐ f   ⌉ᴿ = ⇒ᵢ (⇒ₑ ax (⇒ᵢ (⊗ₑᴸ₁ (eᴸ₁ (eᴸ₂ (⊗ᵢᴸ₁ (⇒ₑ ⌈ f ⌉ᴿ ax)))))))
  ⌈ m⊕  f g ⌉ᴿ = {!!}
  ⌈ m⇛  f g ⌉ᴿ = {!!}
  ⌈ m⇚  f g ⌉ᴿ = {!!}
