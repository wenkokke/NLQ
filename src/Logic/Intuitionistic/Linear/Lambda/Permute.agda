...
module Logic.Intuitionistic.Linear.Lambda.Permute {ℓ} (Univ : Set ℓ) where


open import Logic.Intuitionistic.Linear.Lambda.Type      Univ as T
open import Logic.Intuitionistic.Linear.Lambda.Judgement Univ as J
open import Logic.Intuitionistic.Linear.Lambda.Base      Univ as B
