...
module Logic.Intuitionistic.Unrestricted.Lambda.Judgement.Context {ℓ} (Univ : Set ℓ) where


open import Logic.Intuitionistic.Unrestricted.Lambda.Type         Univ as T
open import Logic.Intuitionistic.Unrestricted.Lambda.Type.Context Univ as TC hiding (module Simple; module Context; Context)
