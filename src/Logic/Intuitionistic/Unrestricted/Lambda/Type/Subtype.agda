...
module Logic.Intuitionistic.Unrestricted.Lambda.Type.Subtype {ℓ} (Univ : Set ℓ) (_≟-Univ_ : (A B : Univ) → Dec (A ≡ B)) where
...
open import Logic.Intuitionistic.Unrestricted.Lambda.Type.Context    Univ as C hiding (module Simple)
