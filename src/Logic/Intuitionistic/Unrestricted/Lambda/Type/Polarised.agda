...
module Logic.Intuitionistic.Unrestricted.Lambda.Type.Polarised {ℓ} (Univ : Polarity → Set ℓ) where


open import Logic.Intuitionistic.Unrestricted.Lambda.Type (Σ Polarity Univ)
