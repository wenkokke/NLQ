...
module Logic.Intuitionistic.Unrestricted.Lambda.Type.Polarised {ℓ} (Univ : Set ℓ) where


open import Logic.Intuitionistic.Unrestricted.Lambda.Type (Polarity × Univ)
