...
version is ever so slightly more verbose:\footnote{%
...
\begin{center}
  \begin{pfbox}
    ...
    \RightLabel{$\mathbf{Q}{\uparrow}$}
    \BIC{$Σ[\struct{\qr[C\himpl(A\himpr B)]}]\fCenter Δ$}
  \end{pfbox}
  \begin{pfbox}
    \AXC{$Σ[\struct{A}]\fCenter\struct{B}$}
    \RightLabel{$\mathbf{Q}{\downarrow}$}
...
% a         \qr[\S\himpl(\NP\himpr\S)]
% different \qr[\S\himpl(\qr[(\NP\himpr\S)\himpl(\A\himpr(\NP\himpr\S))]\himpr\S)]
% waiter    N
% served    TV
% everyone  \qr[\S\himpl(\NP\himpr\S)]
  ...
  \begin{figure}
    \begin{mdframed}
      ...
      \begin{pfblock}[0.85]
        ...
        \AXC{}\RightLabel{Ax}\UIC{$\struct{\S}\fCenter\struct{\S}$}
        \RightLabel{$\mathbf{Q}{\uparrow}$}
        \BIC{$\struct{\qr[\S\himpl(\NP\himpr\S)]}\prod\textsc{served}\prod\struct{\NP}\fCenter\struct{\S}$}
        \RightLabel{Res$\prod\impl$}
        \UIC{$\struct{\qr[\S\himpl(\NP\himpr\S)]}\fCenter\struct{\S}\impl(\textsc{served}\prod\struct{\NP})$}
        \RightLabel{L$\impl$}
        ...
        \AXC{}\RightLabel{Ax}\UIC{$\struct{\S}\fCenter\struct{\S}$}
        \RightLabel{$\mathbf{Q}{\uparrow}$}
        \BIC{$(\B\prod\textsc{a}\prod\qr[(\NP\himpr\S)\himpl(\A\himpr(\NP\himpr\S))]\prod\textsc{waiter})\prod(\B\prod\textsc{served})\prod\I\fCenter\struct{\NP\himpr\S}$}
        \RightLabel{$\beta$}
        \UIC{$\trace((\textsc{a}\prod\qr[(\NP\himpr\S)\himpl(\A\himpr(\NP\himpr\S))]\prod\textsc{waiter})\prodr\textsc{served}\prodr\Box)\fCenter\struct{\NP\himpr\S}$}
        \AXC{}\RightLabel{Ax}\UIC{$\struct{\S}\fCenter\struct{\S}$}
        \RightLabel{$\mathbf{Q}{\uparrow}$}
        \BIC{$(\textsc{a}\prod\qr[(\NP\himpr\S)\himpl(\A\himpr(\NP\himpr\S))]\prod\textsc{waiter})\prod\textsc{served}\prod\textsc{everyone}\fCenter\struct{\S}$}
        \RightLabel{$\mathbf{Q}{\downarrow}$}
        \UIC{$\trace((\textsc{a}\prodr\Box\prodl\textsc{waiter})\prodl\textsc{served}\prod\textsc{everyone})\fCenter\qr[(\NP\himpr\S)\himpl(\A\himpr(\NP\himpr\S))]\himpr\S$}
        \AXC{}\RightLabel{Ax}\UIC{$\struct{\S}\fCenter\struct{\S}$}
        \RightLabel{$\mathbf{Q}{\uparrow}$}
