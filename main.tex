...
In this section, we will discuss some of the limitations of monadic
and effectful semantics---specifically, those relating to movement and
quantification.
We will then discuss extensions made to the syntactic calculus NL, and
see how they can be used to analyse quantification. We will then
present the reader with our own extensions, implemented in display NL,
and show that they can be used to analyse quantification and related
phenomena, while preserving the properties we expect of a grammar
logic (i.e. admissibility of cut, and a decidable and complete proof
search procedure).

\todo{Write general introduction to quantification}
...
\subsection{Parasitic scope and double quantifiers}
