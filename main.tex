...
problematic $\I'$-rule, we will choose the structural version of
$\qr[A]$ to be product with a right-hand unit. However, since we do
not want logical products, we will maintain it as an atomic logical
connective. This gives us the following logical left rule:
\begin{pfblock}
