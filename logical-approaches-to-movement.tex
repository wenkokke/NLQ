...
\todo{Discuss: extension implemented, which distinguishes between
  strong and weak quantifiers and adds $\I^*$-rules for \emph{strong}
  quantifiers.}

\todo{Discuss: extension sketched, which uses the CPS-semantics
  described in a previous section, to have indefinites take
  wide-scope, free of syntactic constraints.}
