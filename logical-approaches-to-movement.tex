...
instance,
\eenumsentence{%
  \item\label{ex:ext1a}``girl who irritated the Duchess''
  \item\label{ex:ext1b}``girl whom the Duchess irritated''}
\eenumsentence{%
...
\input{fig-extension-infixation-and-extraction}
