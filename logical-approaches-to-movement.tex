...
problem of spurious ambiguity in type-logical grammar and
...
\item Both require a \emph{static} choice of answer type. This
  means that the answer type cannot change throughout the program.
...
\]
The system NLQ---and other, similar systems---is capable of deriving
...
which has type $\e\e$, apply it to the existentially quantifier
variable, and insert the result in the subject of the gapped sentence
